import Bible from '../../lib/bible.js'
...
static async getScripture(bible, version) {
	...
	let url = `https://api.scripture.api.bible/v1/bibles/${version}/verses/${ref}?content-type=html&include-notes=false&include-titles=false&include-chapter-numbers=false&include-verse-numbers=false&include-verse-spans=false&use-org-id=false`;
	...
	static async getPassage(ref, version) {
		let result = [];
		let bibleId = 'de4e12af7f28f599-01';
		let url = `https://api.scripture.api.bible/v1/bibles/${version}/passages/${ref}?content-type=html&include-notes=false&include-titles=false&include-chapter-numbers=false&include-verse-numbers=false&include-verse-spans=true&use-org-id=false`;
